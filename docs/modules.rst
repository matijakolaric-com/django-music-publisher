...
about data structure and validation in Common Works Registration, as well as 
various royalty statement formats.

Some examples can be found in tests (:mod:`music_publisher.tests`).
...
music\_publisher.apps
----------------------------

.. automodule:: music_publisher.apps
    :members:
    :show-inheritance:
...
music\_publisher.base
----------------------------

.. automodule:: music_publisher.base
    :members:
    :show-inheritance:

music\_publisher.models
------------------------------

.. automodule:: music_publisher.models
    :members:
    :show-inheritance:

music\_publisher.cwr_templates
-------------------------------------
...
music\_publisher.royalty_calculation
-------------------------------------------
