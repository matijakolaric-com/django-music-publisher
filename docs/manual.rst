...
This is the user manual for Django Music Publisher (|release|), regardless if you installed it yourself or through a specialized platform-as-a-service provider for Django Music Publisher instances, e.g. `DMP Guru <https://dmp.guru>`_.
