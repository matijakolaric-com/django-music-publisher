# Generated by Django 2.2.9 on 2020-01-03 23:38
...
class Migration(migrations.Migration):
    dependencies = [
        ('music_publisher', '0002_auto_20191204_1255'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='society_code',
            field=models.CharField(choices=[('226', 'AACIMH (HONDURAS)'),
                                            ('253', 'AAS (AZERBAIJAN)'),
                                            ('217', 'ABRAC (BRAZIL)'),
                                            ('201', 'ABRAMUS (BRAZIL)'),
                                            ...
                                            ('219', 'ASSIM (BRAZIL)'), ('281',
                                                                        'ATHINA- SADA - S.A.D.A. (GREECE)'),
                                            ('220', 'ATIDA (BRAZIL)'),
                                            ('141', 'ATN (CHILE)'), ('11',
                                                                     'AUSTRO-MECHANA (AUME) (AUSTRIA)'),
                                            ...
                                            ('152',
                                             'Bildupphovsrätt (Visual '
                                             'Copyright Society) (SWEDEN)'),
                                            ('168', 'CA (AUSTRALIA)'),
                                            ...
                                            '108',
                                            'CHA (TAIWAN, CHINESE TAIPEI)'),
                                            ('316', 'CIS-Net AVI (FRANCE)'),
                                            ('312', 'CISAC (FRANCE)'),
                                            ('239', 'CMC (CAMEROON)'),
                                            ('88', 'CMRRA (CANADA)'), ('252',
                                                                       'COLCCMA (TAIWAN, CHINESE TAIPEI)'),
                                            ('106', 'COMPASS (SINGAPORE)'),
                                            ('169', 'COSCAP (BARBADOS)'),
                                            ('124', 'COSOMA (MALAWI)'),
                                            ('268', 'COSON (NIGERIA)'), ('223',
                                                                         'COSOTA (TANZANIA, UNITED REPUBLIC OF)'),
                                            ('284', 'COSOZA (ZANZIBAR)'), (
                                            '96',
                                            ...
                                            '204',
                                            'GCA (former SSA) (GEORGIA)'),
                                            ('297', 'GEDAR (BRAZIL)'),
                                            ('35', 'GEMA (GERMANY)'), ('635',
                                                                       'GEMA-US (Additional CIS-Net Node)'),
                                            ('301', 'GESAC (BELGIUM)'),
                                            ...
                                            ('707', 'MusicMark (USA)'), ('161',
                                                                         'MÜST (TAIWAN, CHINESE TAIPEI)'),
                                            ('102', 'NASCAM (NAMIBIA)'),
                                            ('48', 'NCB (DENMARK)'),
                                            ('160', 'NCIP (BELARUS)'),
                                            ...
                                            ('82', 'OTPDA (TUNISIA)'), ('888',
                                                                        'PAECOL (Additional CIS-Net Node)'),
                                            ...
                                            ('321', 'PUBLISHERS ()'), ('779',
                                                                       'Polaris Nordic (SCANDINAVIA)'),
                                            ('94', 'RAO (RUSSIAN FEDERATION)'),
                                            ('294', 'REDES (COLOMBIA)'), (
                                            '228',
                                            'ROMS (RUSSIAN FEDERATION)'),
                                            ('277', 'RSAU (RWANDA)'),
                                            ('278', 'RUR (RUSSIA)'),
                                            ('55', 'SABAM (BELGIUM)'),
                                            ('221', 'SABEM (BRAZIL)'),
                                            ('56', 'SACD (FRANCE)'),
                                            ('58', 'SACEM (FRANCE)'), ('758',
                                                                       'SACEM-LIBAN (Additional CIS-Net Node)'),
                                            ('658',
                                             'SACEM-US (Additional CIS-Net '
                                             'Node)'),
                                            ('233',
                                             'SACEMLUXEMBOURG (LUXEMBOURG)'),
                                            ('235', 'SACENC (FRANCE)'),
                                            ('57', 'SACERAU (EGYPT)'),
                                            ('242', 'SACIM (EL SALVADOR)'), (
                                            '183',
                                            'SACK (KOREA, REPUBLIC OF)'),
                                            ('59', 'SACM (MEXICO)'),
                                            ('263', 'SACS (SEYCHELLES)'),
                                            ('60', 'SACVEN (VENEZUELA)'),
                                            ('131', 'SADA (GREECE)'),
                                            ...
                                            ('72', 'SGAE (SPAIN)'), ('672',
                                                                     'SGAE-NY (Additional CIS-Net Node)'),
                                            ('186', 'SGDL (FRANCE)'),
                                            ('318', 'SGS ()'),
                                            ('74', 'SIAE (ITALY)'),
                                            ('86', 'SICAM (BRAZIL)'),
                                            ...
                                            ('90', 'TONO (NORWAY)'), ('207',
                                                                      "The "
                                                                      "Author's Registry Inc. (UNITED STATES)"),
                                            ('193',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('226', 'AACIMH (HONDURAS)'),
                                            ...
                                            ('89', 'TEOSTO (FINLAND)'),
                                            ('90', 'TONO (NORWAY)'), ('207',
                                                                      "The Author's Registry Inc. (UNITED STATES)"),
                                            ('193',
                                             'The Society of Authors (SOA) (UNITED KINGDOM)'),
                                            ('140', 'UACRR (UKRAINE)'),
                                            ('93', 'UBC (BRAZIL)'),
                                            ('115', 'UCMR-ADA (ROMANIA)'), (
                                            '194',
                                            'UFFICIO GIURIDICO (HOLY SEE (VATICAN CITY STATE))'),
                                            ('206', 'UFW (FINLAND)'),
                                            ('282', 'UNAC-SA (ANGOLA)'), (
                                            '267',
                                            'UPRAVIS (RUSSIAN FEDERATION)'),
                                            ...
                                            ('196', 'WGA (UNITED STATES)'),
                                            ('197', 'WGJ (JAPAN)'), ('300',
                                                                     'WID Centre (UNITED STATES)'),
                                            ('97', 'ZAIKS (POLAND)'),
                                            ('133', 'ZAMCOPS (ZAMBIA)'), (
                                            '136',
                                            'ZAMP - Macédoine (MACEDONIA)'), (
                                            '198',
                                            'ZAMP Association of Slovenia (SLOVENIA)'),
                                            ('98', 'ZIMURA (ZIMBABWE)'),
                                            ('292', 'ZPAP (POLAND)')],
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('226', 'AACIMH (HONDURAS)'),
                                            ...
                                            '266', 'BeAT (BRUNEI DARUSSALAM)'),
                                            ('152',
                                             'Bildupphovsrätt (Visual Copyright Society) (SWEDEN)'),
                                            ('168', 'CA (AUSTRALIA)'),
                                            ('283', 'CAPASSO (SOUTH AFRICA)'),
                                            ('264', 'CARCC (CANADA)'),
                                            ('26', 'CASH (HONG KONG)'),
                                            ...
                                            ('44', 'MCPS (UNITED KINGDOM)'), (
                                            '311',
                                            'MCPS-PRS Alliance (UNITED KINGDOM)'),
                                            ('119', 'MCSC (CHINA)'),
                                            ('43', 'MCSK (KENYA)'),
                                            ('22', 'MCSN (NIGERIA)'),
                                            ('126', 'MCT (THAILAND)'),
                                            ...
                                            ('58', 'SACEM (FRANCE)'), ('758',
                                                                       'SACEM-LIBAN (Additional CIS-Net Node)'),
                                            ('658',
                                             'SACEM-US (Additional CIS-Net Node)'),
                                            ('233',
                                             'SACEMLUXEMBOURG (LUXEMBOURG)'),
                                            ('235', 'SACENC (FRANCE)'),
                                            ('57', 'SACERAU (EGYPT)'),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True,
                                   ...
                                   validators=[
                                       music_publisher.validators.CWRFieldValidator(
                                           'saan')],
                                   verbose_name='Society-assigned general agreement number'),
        ),
        migrations.AlterField(
            model_name='writer',
            name='sr_society',
        ...
        migrations.AlterField(
            ...
            name='capacity',
            field=models.CharField(blank=True,
                                   choices=[('CA', 'Composer&Lyricist'),
                                            ('C ', 'Composer'),
                                            ('A ', 'Lyricist'),
                                            ('AR', 'Arranger'),
                                            ('AD', 'Adaptor'),
                                            ('TR', 'Translator')],
                                   max_length=2, verbose_name='Role'),
        ),
        migrations.AlterField(
            model_name='writerinwork',
            name='publisher_fee',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True,
                                   ...
                                   max_length=14, null=True, validators=[
                    music_publisher.validators.CWRFieldValidator('saan')],
                                   verbose_name='Society-assigned specific agreement number'),
        ),
    ]
