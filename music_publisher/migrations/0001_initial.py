# Generated by Django 2.2.3 on 2019-12-02 17:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pr_society', models.CharField(blank=True, choices=[('897', 'COMCAP, United Cartoons'), ('879', 'TMI, United Cartoons'), ('987', 'TOONA, Toonya')], max_length=3, null=True, validators=[music_publisher.validators.CWRFieldValidator('writer_pr_society')], verbose_name='Performance rights society')),
                ('mr_society', models.CharField(blank=True, choices=[('897', 'COMCAP, United Cartoons'), ('879', 'TMI, United Cartoons'), ('987', 'TOONA, Toonya')], max_length=3, null=True, validators=[music_publisher.validators.CWRFieldValidator('writer_pr_society')], verbose_name='Mechanical rights society')),
                ('sr_society', models.CharField(blank=True, choices=[('897', 'COMCAP, United Cartoons'), ('879', 'TMI, United Cartoons'), ('987', 'TOONA, Toonya')], max_length=3, null=True, validators=[music_publisher.validators.CWRFieldValidator('writer_pr_society')], verbose_name='Synchronization rights society')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('society_code', models.CharField(choices=[('897', 'COMCAP, United Cartoons'), ('879', 'TMI, United Cartoons'), ('987', 'TOONA, Toonya')], max_length=3, verbose_name='Society')),
