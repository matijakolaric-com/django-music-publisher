# Generated by Django 3.2.6 on 2022-01-22 09:45
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        editable=False, null=True, verbose_name="Last Edited"
                    ),
                ),
                (
                    "artists",
                    models.ManyToManyField(
                        through="music_publisher.ArtistInWork",
                        to="music_publisher.Artist",
                    ),
                ),
            ],
            options={
                ...
                "permissions": (
                    (
                        ...
                        "Can perform royalty calculations",
                    ),
                ),
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        editable=False,
                        verbose_name="Can be controlled",
                    ),
                ),
                (
                    "saan",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="General agreement"
                    ),
                ),
                (
                    "publisher_fee",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Use this field for specific agreements only.For general agreements use the field in the Writer form.",
                        max_length=14,
                        null=True,
                        validators=[
                            music_publisher.validators.CWRFieldValidator(
        ...
        migrations.AddField(
            ...
            name="recordings",
            field=models.ManyToManyField(
                through="music_publisher.Track", to="music_publisher.Recording"
            ),
        ),
        migrations.AddField(
            model_name="release",
        ...
        migrations.AddField(
            ...
            name="releases",
            field=models.ManyToManyField(
                through="music_publisher.Track", to="music_publisher.Release"
            ),
        ),
        migrations.AddField(
            model_name="recording",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "year",
                    models.CharField(
                        blank=True, db_index=True, editable=False, max_length=2
                    ),
                ),
                ...
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=60, verbose_name="Internal Note"
                    ),
                ),
                (
                    "works",
                    models.ManyToManyField(
                        related_name="cwr_exports", to="music_publisher.Work"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                unique=True,
                validators=[
                    music_publisher.validators.CWRFieldValidator("name")
                ],
                verbose_name="Recording ID",
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                max_length=60,
                validators=[
                    music_publisher.validators.CWRFieldValidator("title")
                ],
            ),
        ),
        migrations.AlterField(
